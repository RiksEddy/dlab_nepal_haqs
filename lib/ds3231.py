...
#               sec min hour week day month year
    ...
    def __init__(self,i2c_port,i2c_scl,i2c_sda):
        ...
        self.last_read = None
        self.bus.writeto_mem(int(self.address),int(self.control_reg),b'\x1c') #make sure system is running on battery
    ...
    def read_time(self):
        ...
        e = t[4]&0x3F  #day
        f = t[5]&0x1F  #month
        self.last_read = f"{t[6]:02x}-{t[5]:02x}-{t[4]:02x} {t[2]:02x}:{t[1]:02x}:{t[0]:02x}"
        #print("20%x-%02x-%02x %02x:%02x:%02x" %(t[6],t[5],t[4],t[2],t[1],t[0])) #,self.w[t[3]-1]))
...
#     rtc.set_time('11:42:30,Friday,2023-05-19')
#     while True:
